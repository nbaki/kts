...
function setActiveTab(page) {
    if (page == 'Home') {
            $('#home_link').css('padding-bottom', 15);
            ...
            $('#about_link').css('padding-bottom', 15);
            ...
            $('#processes_link').css('padding-bottom', 15);
            ...
            $('#services_link').css('padding-bottom', 15);
            ...
            $('#contact_link').css('padding-bottom', 15);
